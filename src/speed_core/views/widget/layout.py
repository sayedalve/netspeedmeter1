...
from speed_core.utils.taskbar_utils import is_small_taskbar, get_taskbar_info

if TYPE_CHECKING:
    from speed_core.views.widget.main import NetworkSpeedWidget
        ...
        try:
            ...
            if is_horizontal:
                ...
                if is_small:
                    ...
                    from speed_core.utils.helpers import get_reference_value_string, get_unit_labels_for_type
                    ...
                    from speed_core.utils.helpers import get_all_possible_unit_labels, get_reference_value_string
