...
from speed_core.core.monitor_thread   import StatsMonitorThread
from speed_core.core.position_manager import PositionManager, WindowState
from speed_core.core.startup_manager  import StartupManager
from speed_core.core.system_events    import SystemEventHandler
from speed_core.core.tray_manager     import TrayIconManager
from speed_core.core.widget_state     import WidgetState
from speed_core.core.config_controller import ConfigController
from speed_core.core.input_handler    import InputHandler
from speed_core.utils.config          import ConfigManager
from speed_core.utils.taskbar_utils   import (
    get_taskbar_info, is_taskbar_obstructed, is_taskbar_visible,
)
from speed_core.utils.speed_renderer  import SpeedRenderer
from speed_core.views.widget.layout   import WidgetLayoutManager
from speed_core.views.widget.theme    import WidgetThemeManager
...
class NetSpeedMeterWidget(QWidget):
    ...
    def show_settings(self) -> None:
        from speed_core.views.speed_settings import SpeedSettingsDialog
