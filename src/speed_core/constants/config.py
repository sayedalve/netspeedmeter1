...
from speed_core.constants.i18n import I18nStrings
from speed_core.constants.ui import ui as ui_constants
...
class ConfigConstants:
    ...
    VALIDATION_SCHEMA: Final[Dict[str, Dict[str, Any]]] = {
        ...
        "font_size_speed":              {"type": int,              "default": 11, "min": 8, "max": 36},
        "font_size_unit":               {"type": int,              "default": 8, "min": 6, "max": 24},
