...
class FontConstants:
    ...
    # =====================================================================
    # --- UI Scaling Controls (Internet Speed Meter) ---
    # Change these values to make the text bigger or smaller
    # =====================================================================
    SIZE_BASE_SPEED: Final[int] = 11    # The main upload/download numbers (e.g., 0.0)
    SIZE_BASE_UNIT: Final[int] = 8      # The units text (e.g., MB/s)
    
    # Derived Sizes for the Renderer
    SIZE_SPEED_LARGE: Final[int] = SIZE_BASE_SPEED
    SIZE_UNIT_MEDIUM: Final[int] = SIZE_BASE_UNIT
    SIZE_ARROW: Final[int] = SIZE_BASE_SPEED + 1  # The ↑ and ↓ arrows
    # =====================================================================
