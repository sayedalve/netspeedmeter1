...
# Add src to path
# Adjusted path for: src/speed_core/tests/debug_graph_perf.py -> src
src_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../'))
sys.path.insert(0, src_path)

try:
    from speed_core.views.graph.window import GraphWindow
    from speed_core.core.widget_state import WidgetState, SpeedDataSnapshot, AggregatedSpeedData
