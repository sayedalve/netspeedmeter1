...
from speed_core.core.position_manager import PositionManager, PositionCalculator, ScreenPosition, WindowState, ScreenUtils
from speed_core.utils.taskbar_utils import TaskbarInfo
...
class TestPositionManager(unittest.TestCase):
    ...
    @patch('speed_core.core.position_manager.get_taskbar_info')
