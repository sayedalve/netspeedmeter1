...
class TestMultiMonitorScreenDetection:
    ...
    def test_screen_detection_side_by_side_monitors(self):
        ...
        """
        from speed_core.core.position_manager import ScreenUtils
        ...
        with patch('speed_core.core.position_manager.QApplication.screenAt') as mock_screen_at:
...
if __name__ == "__main__":
    ...
    @patch('speed_core.core.position_manager.QApplication')
