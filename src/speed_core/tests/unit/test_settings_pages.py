...
from speed_core.views.settings.pages.general import GeneralPage
from speed_core.views.settings.pages.appearance import AppearancePage
from speed_core.views.settings.pages.units import UnitsPage
from speed_core.views.settings.pages.interfaces import InterfacesPage
from speed_core.views.settings.pages.colors import ColorsPage
