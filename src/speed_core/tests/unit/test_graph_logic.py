...
from speed_core.views.graph import GraphWindow
from speed_core.views.graph.logic import GraphLogic
...
def graph_window_instance(qapp) -> Iterator[GraphWindow]:
    ...
    with patch('speed_core.views.graph.window.GraphRenderer', return_value=MagicMock()), \
         patch('speed_core.views.graph.window.GraphInteractionHandler', return_value=MagicMock()), \
         patch('speed_core.utils.helpers.get_app_asset_path', return_value=MagicMock()), \
