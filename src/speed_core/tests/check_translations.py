...
def check_translations():
    ...
    project_root = os.path.abspath(os.path.join(script_dir, "../../..")) # src/speed_core/tests -> project root
    
    # Try a few candidate paths for locales
    candidates = [
        os.path.join(script_dir, "../constants/locales"),
        os.path.join(project_root, "src/speed_core/constants/locales"),
        "src/speed_core/constants/locales"
    ]
