"""
Background Hardware Monitor Thread for speed_core.
...
from speed_core.utils.rdp_utils import is_rdp_session

logger = logging.getLogger("speed_core.StatsMonitorThread")
...
class StatsMonitorThread(QThread):
    ...
    def _init_ohm_wmi(self) -> None:
        ...
        allowing the app to pick up LHM/OHM if it starts after speed_core.
        """
