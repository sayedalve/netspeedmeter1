"""
Controller module for speed_core.
...
from speed_core.utils.network_utils import get_primary_interface_name

if TYPE_CHECKING:
    from speed_core.views.widget import NetworkSpeedWidget
    from speed_core.core.widget_state import WidgetState

logger = logging.getLogger("speed_core.StatsController")
