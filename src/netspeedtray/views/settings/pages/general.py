...
class GeneralPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        lp_label = QLabel(self.i18n.LOCK_POSITION_LABEL)
        self.lock_position = Win11Toggle(label_text="")
        self.lock_position.toggled.connect(self.on_change)

        behavior_layout.addWidget(lp_label, 2, 0, Qt.AlignmentFlag.AlignVCenter)
        behavior_layout.addWidget(self.lock_position, 2, 1, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        ...
        behavior_layout.addWidget(kvf_label, 3, 0, Qt.AlignmentFlag.AlignVCenter)
        behavior_layout.addWidget(self.keep_visible_fullscreen, 3, 1, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def load_settings(self, config: Dict[str, Any], is_startup_enabled: bool):
        ...
        self.lock_position.setChecked(config.get("lock_position", False))
